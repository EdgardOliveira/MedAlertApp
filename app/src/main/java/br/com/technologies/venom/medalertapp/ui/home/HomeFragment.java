...
public class HomeFragment extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        final Button btnConsultarReceita = binding.btnConsultarReceita;

        btnConsultarReceita.setOnClickListener(this);
...
//        });
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.btnConsultarReceita:
                homeViewModel.consultarReceita();
                break;
        }
    }
}